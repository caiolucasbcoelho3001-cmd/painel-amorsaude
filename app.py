...
SHEET_NAME = "Página1"  # Ajuste para o nome da aba correta
SERVICE_FILE = "google_service.json"  # arquivo de credenciais
...
# =========================
    ...
    # Exibição dos registros e atualização de status
